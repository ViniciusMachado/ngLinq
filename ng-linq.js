...
/*describe('ng-Linq Test', function () {
    var httpBackend,
        service;

    var Usuarios =
        [
            { "Login": "ADM", "Name": "Administrador", "Grupo": "1", "Email": "Adm@nglinq.com" },
            { "Login": "Taila", "Name": "Taila Rosa", "Grupo": "1", "Email": "Taila@nglinq.com" },
            { "Login": "Vine", "Name": "Vinicius Machado", "Grupo": "1", "Email": "Vine@nglinq.com" }
        ];

    beforeEach(function () {
        module('ng-Linq');
        inject(function ($httpBackend, Linq) {
    ...
    it('Count', function () {
        ...
        service.Count(Usuarios).then(function (data) {
            result = data;
        });
